...
export function CarDetails({ car, testDriveInfo }) {
    ...
    const handleBookTestDrive = () => {
        ...
        console.log("car in car detail", car);
    ...
    return (
        <div>
            <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    {car.images && car.images.length > 1 && (
                        <div className="flex gap-2 overflow-x-auto pb-2">
                            {car.images.map((image, index) => (
                                <div
                                    key={index}
                                    className={`relative cursor-pointer rounded-lg h-20 w-24 flex-shrink-0 transition-all duration-200 ${index === currentImageIndex
                ...
                {/* Car Details */}
                <div className="w-full lg:w-5/12 bg-white rounded-xl p-6 shadow-sm">
                    ...
                    {/* Quick Stats */}
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-6 bg-gray-50 p-4 rounded-lg">
